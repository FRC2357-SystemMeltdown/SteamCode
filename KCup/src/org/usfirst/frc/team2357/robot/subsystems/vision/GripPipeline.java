...
/**
 * This class was originally generated by GRIP but has been modified to handle
 * both the peg vision targets and our feeder target. It has also been modified
 * to get the RGB values for both targets from configuration.
 */
public class GripPipeline implements VisionPipeline {
	...
	public GripPipeline(VisionSubsystem visionSubsystem) {
	...
	public void process(Mat source0) {
		...
		if (this.visionSubsystem.searchingForFeeder()) {
			rgbThresholdRed[0] = this.visionSubsystem.props.feederTargetRGBLow[0];
			rgbThresholdRed[1] = this.visionSubsystem.props.feederTargetRGBHigh[0];
			rgbThresholdGreen[0] = this.visionSubsystem.props.feederTargetRGBLow[1];
			rgbThresholdGreen[1] = this.visionSubsystem.props.feederTargetRGBHigh[1];
			rgbThresholdBlue[0] = this.visionSubsystem.props.feederTargetRGBLow[2];
			rgbThresholdBlue[1] = this.visionSubsystem.props.feederTargetRGBHigh[2];
		} else {
			rgbThresholdRed[0] = this.visionSubsystem.props.pegTargetRGBLow[0];
			rgbThresholdRed[1] = this.visionSubsystem.props.pegTargetRGBHigh[0];
			rgbThresholdGreen[0] = this.visionSubsystem.props.pegTargetRGBLow[1];
			rgbThresholdGreen[1] = this.visionSubsystem.props.pegTargetRGBHigh[1];
			rgbThresholdBlue[0] = this.visionSubsystem.props.pegTargetRGBLow[2];
			rgbThresholdBlue[1] = this.visionSubsystem.props.pegTargetRGBHigh[2];
		}
		...
		double[] filterContoursSolidity = { 69.24460431654676, 100 };
