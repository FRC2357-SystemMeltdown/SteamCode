 ...
 *
 */
public class RedCenterGearAuto extends CommandGroup {

    public RedCenterGearAuto() {
        // Add Commands here:
    	...
    	addSequential(new ForeverDriveToPeg(0.4, 0.0)); //addSequential(new DriveUntilPegged(36));
